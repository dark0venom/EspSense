...
void
master_yppasswdprog_1(struct svc_req *rqstp, SVCXPRT *transp)
{
	union {
		master_yppasswd yppasswdproc_update_master_1_arg;
	} argument;
	char *result;
	...
	case YPPASSWDPROC_UPDATE_MASTER:
		xdr_argument = (xdrproc_t) xdr_master_yppasswd;
		xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) yppasswdproc_update_master_1_svc;
		break;
