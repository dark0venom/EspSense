...
const char *
sysdecode_ioctlname(unsigned long val)
{
	const char *str = NULL;
	...
	if (val == AACIO_STATS)
		...
		str = "APMIO_SUSPEND";
	else if (val == AUDIO_COMPAT_DRAIN)
		str = "AUDIO_COMPAT_DRAIN";
	else if (val == AUDIO_COMPAT_FLUSH)
		str = "AUDIO_COMPAT_FLUSH";
	else if (val == AUDIO_DRAIN)
		str = "AUDIO_DRAIN";
	else if (val == AUDIO_FLUSH)
		str = "AUDIO_FLUSH";
	else if (val == AUDIO_GETINFO)
		str = "AUDIO_GETINFO";
	else if (val == AUDIO_SETINFO)
		str = "AUDIO_SETINFO";
	...
	else if (val == CPUCTL_EVAL_CPU_FEATURES)
		str = "CPUCTL_EVAL_CPU_FEATURES";
		...
		str = "DEV_ATTACH";
	else if (val == DEV_CLEAR_DRIVER)
		str = "DEV_CLEAR_DRIVER";
	else if (val == DEV_DELETE)
		str = "DEV_DELETE";
		...
		str = "DIOCIGETIFACES";
	else if (val == DIOCKILLSCHEDULE)
		str = "DIOCKILLSCHEDULE";
		...
		str = "DVDIOCSENDKEY";
	else if (val == EFIIOC_GET_TABLE)
		str = "EFIIOC_GET_TABLE";
	else if (val == EFIIOC_GET_TIME)
		str = "EFIIOC_GET_TIME";
	else if (val == EFIIOC_SET_TIME)
		str = "EFIIOC_SET_TIME";
	else if (val == EFIIOC_VAR_GET)
		str = "EFIIOC_VAR_GET";
	else if (val == EFIIOC_VAR_NEXT)
		str = "EFIIOC_VAR_NEXT";
	else if (val == EFIIOC_VAR_SET)
		str = "EFIIOC_VAR_SET";
	...
	else if (val == EVIOCGEFFECTS)
		str = "EVIOCGEFFECTS";
	else if (val == EVIOCGID)
		str = "EVIOCGID";
	else if (val == EVIOCGKEYCODE)
		str = "EVIOCGKEYCODE";
	else if (val == EVIOCGKEYCODE_V2)
		str = "EVIOCGKEYCODE_V2";
	else if (val == EVIOCGRAB)
		str = "EVIOCGRAB";
	else if (val == EVIOCGREP)
		str = "EVIOCGREP";
	else if (val == EVIOCGVERSION)
		str = "EVIOCGVERSION";
	else if (val == EVIOCREVOKE)
		str = "EVIOCREVOKE";
	else if (val == EVIOCRMFF)
		str = "EVIOCRMFF";
	else if (val == EVIOCSCLOCKID)
		str = "EVIOCSCLOCKID";
	else if (val == EVIOCSFF)
		str = "EVIOCSFF";
	else if (val == EVIOCSKEYCODE)
		str = "EVIOCSKEYCODE";
	else if (val == EVIOCSKEYCODE_V2)
		str = "EVIOCSKEYCODE_V2";
	else if (val == EVIOCSREP)
		str = "EVIOCSREP";
		...
		str = "GIO_VFONT";
	else if (val == GPIOACCESS32)
		str = "GPIOACCESS32";
	else if (val == GPIOCONFIG32)
		str = "GPIOCONFIG32";
	else if (val == GPIOGET)
		str = "GPIOGET";
		...
		str = "GPIOMAXPIN";
	else if (val == GPIOMAXPWM)
		str = "GPIOMAXPWM";
	else if (val == GPIOPWMGET)
		str = "GPIOPWMGET";
	else if (val == GPIOPWMGETCONFIG)
		str = "GPIOPWMGETCONFIG";
	else if (val == GPIOPWMSET)
		str = "GPIOPWMSET";
	else if (val == GPIOSET)
		str = "GPIOSET";
		...
		str = "IOCATASSPINDOWN";
	else if (val == IOCHVVSSREAD)
		str = "IOCHVVSSREAD";
	else if (val == IOCHVVSSWRITE)
		str = "IOCHVVSSWRITE";
	...
	else if (val == IPSECGREQID)
		str = "IPSECGREQID";
	else if (val == IPSECSREQID)
		str = "IPSECSREQID";
		...
		str = "KIOCSOUND";
	else if (val == LMCIOCGCFG)
		str = "LMCIOCGCFG";
	else if (val == LMCIOCGSTAT)
		str = "LMCIOCGSTAT";
	else if (val == LMCIOCREAD)
		str = "LMCIOCREAD";
	else if (val == LMCIOCSCFG)
		str = "LMCIOCSCFG";
	else if (val == LMCIOCTL)
		str = "LMCIOCTL";
	else if (val == LMCIOCWRITE)
		str = "LMCIOCWRITE";
	else if (val == LPT_IRQ)
		str = "LPT_IRQ";
		...
		str = "MIOSPASSTHRU";
	else if (val == MLX5_FWDUMP_FORCE)
		str = "MLX5_FWDUMP_FORCE";
	else if (val == MLX5_FWDUMP_GET)
		str = "MLX5_FWDUMP_GET";
	else if (val == MLX5_FWDUMP_RESET)
		str = "MLX5_FWDUMP_RESET";
	else if (val == MMC_IOC_CMD)
		str = "MMC_IOC_CMD";
	else if (val == MMC_IOC_MULTI_CMD)
		str = "MMC_IOC_MULTI_CMD";
		...
		str = "PMIOGET";
	else if (val == PMIOREAD)
		str = "PMIOREAD";
	else if (val == PMIORESET)
		str = "PMIORESET";
	else if (val == PMIOSETUP)
		str = "PMIOSETUP";
	else if (val == PMIOSTART)
		str = "PMIOSTART";
	else if (val == PMIOSTOP)
		str = "PMIOSTOP";
	else if (val == PMIOTSTAMP)
		str = "PMIOTSTAMP";
		...
		str = "REMOTE_GETKEY";
	else if (val == SERIAL_ADDDLCI)
		str = "SERIAL_ADDDLCI";
	else if (val == SERIAL_CLRSTAT)
		str = "SERIAL_CLRSTAT";
	else if (val == SERIAL_GETBAUD)
		str = "SERIAL_GETBAUD";
	else if (val == SERIAL_GETCABLE)
		str = "SERIAL_GETCABLE";
	else if (val == SERIAL_GETCABLEN)
		str = "SERIAL_GETCABLEN";
	else if (val == SERIAL_GETCFG)
		str = "SERIAL_GETCFG";
	else if (val == SERIAL_GETCLK)
		str = "SERIAL_GETCLK";
	else if (val == SERIAL_GETCRC4)
		str = "SERIAL_GETCRC4";
	else if (val == SERIAL_GETDEBUG)
		str = "SERIAL_GETDEBUG";
	else if (val == SERIAL_GETDIR)
		str = "SERIAL_GETDIR";
	else if (val == SERIAL_GETDPLL)
		str = "SERIAL_GETDPLL";
	else if (val == SERIAL_GETDXC)
		str = "SERIAL_GETDXC";
	else if (val == SERIAL_GETE3STAT)
		str = "SERIAL_GETE3STAT";
	else if (val == SERIAL_GETESTAT)
		str = "SERIAL_GETESTAT";
	else if (val == SERIAL_GETHIGAIN)
		str = "SERIAL_GETHIGAIN";
	else if (val == SERIAL_GETINVCLK)
		str = "SERIAL_GETINVCLK";
	else if (val == SERIAL_GETINVRCLK)
		str = "SERIAL_GETINVRCLK";
	else if (val == SERIAL_GETINVTCLK)
		str = "SERIAL_GETINVTCLK";
	else if (val == SERIAL_GETIRQ)
		str = "SERIAL_GETIRQ";
	else if (val == SERIAL_GETKEEPALIVE)
		str = "SERIAL_GETKEEPALIVE";
	else if (val == SERIAL_GETLCODE)
		str = "SERIAL_GETLCODE";
	else if (val == SERIAL_GETLEVEL)
		str = "SERIAL_GETLEVEL";
	else if (val == SERIAL_GETLOOP)
		str = "SERIAL_GETLOOP";
	else if (val == SERIAL_GETMASTER)
		str = "SERIAL_GETMASTER";
	else if (val == SERIAL_GETMODE)
		str = "SERIAL_GETMODE";
	else if (val == SERIAL_GETMONITOR)
		str = "SERIAL_GETMONITOR";
	else if (val == SERIAL_GETMTU)
		str = "SERIAL_GETMTU";
	else if (val == SERIAL_GETNAME)
		str = "SERIAL_GETNAME";
	else if (val == SERIAL_GETNRZI)
		str = "SERIAL_GETNRZI";
	else if (val == SERIAL_GETPHONY)
		str = "SERIAL_GETPHONY";
	else if (val == SERIAL_GETPORT)
		str = "SERIAL_GETPORT";
	else if (val == SERIAL_GETPROTO)
		str = "SERIAL_GETPROTO";
	else if (val == SERIAL_GETREGISTERED)
		str = "SERIAL_GETREGISTERED";
	else if (val == SERIAL_GETRLOOP)
		str = "SERIAL_GETRLOOP";
	else if (val == SERIAL_GETRQLEN)
		str = "SERIAL_GETRQLEN";
	else if (val == SERIAL_GETSCRAMBLER)
		str = "SERIAL_GETSCRAMBLER";
	else if (val == SERIAL_GETSTAT)
		str = "SERIAL_GETSTAT";
	else if (val == SERIAL_GETSUBCHAN)
		str = "SERIAL_GETSUBCHAN";
	else if (val == SERIAL_GETTIMESLOTS)
		str = "SERIAL_GETTIMESLOTS";
	else if (val == SERIAL_GETTIMO)
		str = "SERIAL_GETTIMO";
	else if (val == SERIAL_GETUNFRAM)
		str = "SERIAL_GETUNFRAM";
	else if (val == SERIAL_GETUSE16)
		str = "SERIAL_GETUSE16";
	else if (val == SERIAL_GETVERSIONSTRING)
		str = "SERIAL_GETVERSIONSTRING";
	else if (val == SERIAL_HARDRESET)
		str = "SERIAL_HARDRESET";
	else if (val == SERIAL_RESET)
		str = "SERIAL_RESET";
	else if (val == SERIAL_SETBAUD)
		str = "SERIAL_SETBAUD";
	else if (val == SERIAL_SETCABLEN)
		str = "SERIAL_SETCABLEN";
	else if (val == SERIAL_SETCFG)
		str = "SERIAL_SETCFG";
	else if (val == SERIAL_SETCLK)
		str = "SERIAL_SETCLK";
	else if (val == SERIAL_SETCRC4)
		str = "SERIAL_SETCRC4";
	else if (val == SERIAL_SETDEBUG)
		str = "SERIAL_SETDEBUG";
	else if (val == SERIAL_SETDIR)
		str = "SERIAL_SETDIR";
	else if (val == SERIAL_SETDPLL)
		str = "SERIAL_SETDPLL";
	else if (val == SERIAL_SETDXC)
		str = "SERIAL_SETDXC";
	else if (val == SERIAL_SETHIGAIN)
		str = "SERIAL_SETHIGAIN";
	else if (val == SERIAL_SETINVCLK)
		str = "SERIAL_SETINVCLK";
	else if (val == SERIAL_SETINVRCLK)
		str = "SERIAL_SETINVRCLK";
	else if (val == SERIAL_SETINVTCLK)
		str = "SERIAL_SETINVTCLK";
	else if (val == SERIAL_SETKEEPALIVE)
		str = "SERIAL_SETKEEPALIVE";
	else if (val == SERIAL_SETLCODE)
		str = "SERIAL_SETLCODE";
	else if (val == SERIAL_SETLOOP)
		str = "SERIAL_SETLOOP";
	else if (val == SERIAL_SETMASTER)
		str = "SERIAL_SETMASTER";
	else if (val == SERIAL_SETMODE)
		str = "SERIAL_SETMODE";
	else if (val == SERIAL_SETMONITOR)
		str = "SERIAL_SETMONITOR";
	else if (val == SERIAL_SETMTU)
		str = "SERIAL_SETMTU";
	else if (val == SERIAL_SETNRZI)
		str = "SERIAL_SETNRZI";
	else if (val == SERIAL_SETPHONY)
		str = "SERIAL_SETPHONY";
	else if (val == SERIAL_SETPORT)
		str = "SERIAL_SETPORT";
	else if (val == SERIAL_SETPROTO)
		str = "SERIAL_SETPROTO";
	else if (val == SERIAL_SETRLOOP)
		str = "SERIAL_SETRLOOP";
	else if (val == SERIAL_SETRQLEN)
		str = "SERIAL_SETRQLEN";
	else if (val == SERIAL_SETSCRAMBLER)
		str = "SERIAL_SETSCRAMBLER";
	else if (val == SERIAL_SETSUBCHAN)
		str = "SERIAL_SETSUBCHAN";
	else if (val == SERIAL_SETTIMESLOTS)
		str = "SERIAL_SETTIMESLOTS";
	else if (val == SERIAL_SETTIMO)
		str = "SERIAL_SETTIMO";
	else if (val == SERIAL_SETUNFRAM)
		str = "SERIAL_SETUNFRAM";
	else if (val == SERIAL_SETUSE16)
		str = "SERIAL_SETUSE16";
	else if (val == SETFKEY)
		str = "SETFKEY";
	...
	else if (val == SIOCGIFRSSHASH)
		str = "SIOCGIFRSSHASH";
	else if (val == SIOCGIFRSSKEY)
		str = "SIOCGIFRSSKEY";
		...
		str = "SIOCGVH";
	else if (val == SIOCGWLCACHE)
		str = "SIOCGWLCACHE";
	else if (val == SIOCGWLCITEM)
		str = "SIOCGWLCITEM";
	else if (val == SIOCGWLCNWID)
		str = "SIOCGWLCNWID";
	else if (val == SIOCGWLEEPROM)
		str = "SIOCGWLEEPROM";
	else if (val == SIOCGWLPSA)
		str = "SIOCGWLPSA";
		...
		str = "SIOCSWAPA";
	else if (val == SIOCSWLCNWID)
		str = "SIOCSWLCNWID";
	else if (val == SIOCSWLPSA)
		str = "SIOCSWLPSA";
	else if (val == SIOCSWLTHR)
		str = "SIOCSWLTHR";
	else if (val == SIOCZRLST)
		str = "SIOCZRLST";
	else if (val == SMAPIOCGFUNCTION)
		str = "SMAPIOCGFUNCTION";
	else if (val == SMAPIOGHEADER)
		str = "SMAPIOGHEADER";
	...
	else if (val == SPIGENIOC_GET_CLOCK_SPEED)
		str = "SPIGENIOC_GET_CLOCK_SPEED";
	else if (val == SPIGENIOC_GET_SPI_MODE)
		str = "SPIGENIOC_GET_SPI_MODE";
	else if (val == SPIGENIOC_SET_CLOCK_SPEED)
		str = "SPIGENIOC_SET_CLOCK_SPEED";
	else if (val == SPIGENIOC_SET_SPI_MODE)
		str = "SPIGENIOC_SET_SPI_MODE";
	else if (val == SPIGENIOC_TRANSFER)
		str = "SPIGENIOC_TRANSFER";
	else if (val == SPIGENIOC_TRANSFER_MMAPPED)
		str = "SPIGENIOC_TRANSFER_MMAPPED";
	...
	else if (val == UI_ABS_SETUP)
		str = "UI_ABS_SETUP";
	else if (val == UI_BEGIN_FF_ERASE)
		str = "UI_BEGIN_FF_ERASE";
	else if (val == UI_BEGIN_FF_UPLOAD)
		str = "UI_BEGIN_FF_UPLOAD";
	else if (val == UI_DEV_CREATE)
		str = "UI_DEV_CREATE";
	else if (val == UI_DEV_DESTROY)
		str = "UI_DEV_DESTROY";
	else if (val == UI_DEV_SETUP)
		str = "UI_DEV_SETUP";
	else if (val == UI_END_FF_ERASE)
		str = "UI_END_FF_ERASE";
	else if (val == UI_END_FF_UPLOAD)
		str = "UI_END_FF_UPLOAD";
	else if (val == UI_GET_VERSION)
		str = "UI_GET_VERSION";
	else if (val == UI_SET_ABSBIT)
		str = "UI_SET_ABSBIT";
	else if (val == UI_SET_EVBIT)
		str = "UI_SET_EVBIT";
	else if (val == UI_SET_FFBIT)
		str = "UI_SET_FFBIT";
	else if (val == UI_SET_KEYBIT)
		str = "UI_SET_KEYBIT";
	else if (val == UI_SET_LEDBIT)
		str = "UI_SET_LEDBIT";
	else if (val == UI_SET_MSCBIT)
		str = "UI_SET_MSCBIT";
	else if (val == UI_SET_PHYS)
		str = "UI_SET_PHYS";
	else if (val == UI_SET_PROPBIT)
		str = "UI_SET_PROPBIT";
	else if (val == UI_SET_RELBIT)
		str = "UI_SET_RELBIT";
	else if (val == UI_SET_SNDBIT)
		str = "UI_SET_SNDBIT";
	else if (val == UI_SET_SWBIT)
		str = "UI_SET_SWBIT";
