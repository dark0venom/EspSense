...
#define MASK_POPCNT (1 << 18)
#define MASK_RTD (1 << 19)
#define MASK_SSE (1 << 20)
#define MASK_SSE2 (1 << 21)
#define MASK_SSE3 (1 << 22)
...
#define TARGET_POPCNT ((target_flags & MASK_POPCNT) != 0)
...
enum opt_code
{
  ...
  OPT_Wvariable_decl,                        /* -Wvariable-decl */
  ...
  OPT_fstack_protector_strong,               /* -fstack-protector-strong */
  OPT_fstats,                                /* -fstats */
